    ...
    <div className="p-5 rounded-xl border border-border bg-card text-card-foreground shadow-2xs space-y-4">
      ...
      <div className="space-y-3">
        {benchmarks.map((bm, idx) => (
          <div key={idx} className="p-3.5 rounded-lg bg-secondary/30 border border-border space-y-2 text-xs">
            <div className="flex justify-between items-center">
              ...
              <span className="font-mono font-bold text-emerald-500">+{bm.realizedRoi}% ROI</span>
            </div>
            ...
            <div className="grid grid-cols-3 gap-2 text-[10px] text-muted-foreground pt-1 border-t border-border/40">
              ...
              <div>
                ...
                <span className="font-mono font-bold text-accent block">{bm.aiAdoptionPercentage}% Rate</span>
              </div>
            </div>
          </div>
        ))}
