    ...
    <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
      ...
      <div className="p-5 rounded-xl border border-border bg-card text-card-foreground shadow-2xs space-y-4">
        <div className="flex items-center justify-between border-b border-border/60 pb-2">
          ...
          <span className="text-[10px] font-mono font-bold text-emerald-500">+215% Overall ROI</span>
        </div>
      ...
      <div className="p-5 rounded-xl border border-border bg-card text-card-foreground shadow-2xs space-y-4">
        ...
        <div className="space-y-3">
          {[
            { area: "Operations & Care", percentage: 38, amount: "$1,100,000", color: "bg-indigo-500" },
            { area: "Software Engineering", percentage: 31, amount: "$900,000", color: "bg-accent" },
            { area: "Legal & Compliance", percentage: 17, amount: "$500,000", color: "bg-purple-500" },
      ...
      <div className="p-5 rounded-xl border border-border bg-card text-card-foreground shadow-2xs space-y-4 md:col-span-2">
        <div className="flex items-center justify-between border-b border-border/60 pb-2">
          <div className="flex items-center gap-2">
        ...
        <div className="grid grid-cols-3 gap-3 text-center text-xs">
          <div className="p-4 rounded-lg bg-emerald-500/10 border border-emerald-500/20 space-y-1">
            <span className="font-bold text-emerald-500 block">Low Risk / High Impact</span>
          ...
          <div className="p-4 rounded-lg bg-amber-500/10 border border-amber-500/20 space-y-1">
            <span className="font-bold text-amber-500 block">Medium Risk / High Impact</span>
          ...
          <div className="p-4 rounded-lg bg-rose-500/10 border border-rose-500/20 space-y-1">
            <span className="font-bold text-rose-500 block">High Risk / High Impact</span>
